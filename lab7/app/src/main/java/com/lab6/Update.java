...
public class Update extends AsyncTask<Params, Void, Boolean> {
    ...
    protected Boolean doInBackground(Params... params) {
        ...
        db.execSQL("UPDATE items set count =" + count + ", price = " + price + " where name=\"" + name + "\"");
        db.close();
    ...
    protected void onPostExecute(Boolean result) {
        ...
        String message = "Товар \"" + name + "\"" + "обновлен.";
